...
STAGE4_RUN="${STAGE4_RUN:-hercules_radar4}"
STAGE5_RUN="${STAGE5_RUN:-hercules_radar5}"
...
TAG="${TAG:-CMRNext-5Stage}"
SCENE_TAG="${SCENE_TAG:-multi_scene}"
RESULT_BASENAME="${RESULT_BASENAME:-cmrnext_5stage_val_${SCENE_TAG}_rot${MAX_R}_trans${MAX_T}_${NUM_TRIALS}seeds}"
...
STAGE4_CKPT="${STAGE4_CKPT:-$(find_latest_checkpoint "$STAGE4_RUN")}"
STAGE5_CKPT="${STAGE5_CKPT:-$(find_latest_checkpoint "$STAGE5_RUN")}"
...
echo "============================================================"
echo "Evaluating 5-stage CMRNext on Hercules"
...
echo "  stage4 run  : $STAGE4_RUN"
echo "  stage4 ckpt : $STAGE4_CKPT"
echo "  stage5 run  : $STAGE5_RUN"
echo "  stage5 ckpt : $STAGE5_CKPT"
...
cmd=(
    ...
    --weights "$STAGE1_CKPT" "$STAGE2_CKPT" "$STAGE3_CKPT" "$STAGE4_CKPT" "$STAGE5_CKPT"
    --max_t "$MAX_T"
    --max_r "$MAX_R"
